(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('bookMicroservicesApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-bookMicroservicesApp-error');
                var entityKey = httpResponse.headers('X-bookMicroservicesApp-params');
                if (errorHeader) {
